...
<div id="add_menu" class="container">
	...
	<div class="content">
		...
		<div style="margin-bottom:30px;">
			...
			<form name="form1" action="<%=path%>/menu/add" method="post" >
...
<!-- 									<option value="click">单击型</option> -->
                        ...
                        <tr>
							...
							<td class="left"><input class="input_content" type="text" id="showOrder" name="showOrder"></td>
						</tr>
